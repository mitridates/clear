...
class CaveGridSerializer extends AbstractSerializer
{

    protected $type = 'cavegrid';
     ...
     * @return Relationship
     */
    public function cave(Cavegrid $model): ?Relationship
    {
     ...
     * @return Relationship
     */
    public function units(Cavegrid $model): ?Relationship
    {
        return new Relationship(new Resource($model->getUnits(), new FieldValueCodeSerializer($this->locale)));
    }
     ...
     * @return Relationship
     */
    public function map(Cavegrid $model): ?Relationship
    {
