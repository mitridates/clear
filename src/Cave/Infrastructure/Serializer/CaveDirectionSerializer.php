...
class CaveDirectionSerializer extends AbstractSerializer
{

    protected $type = 'cavedirection';
     ...
     * @return Relationship
     */
    public function cave(Cavedirection $model): ?Relationship
    {
