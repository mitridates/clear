...
class CaveEntranceftSerializer extends AbstractSerializer
{

    protected $type = 'caveentranceft';
     ...
     * @return Relationship
     */
    public function cave(Caveentranceft $model): ?Relationship
    {
     ...
     * @return Relationship
     */
    public function entrance(Caveentranceft $model): ?Relationship
    {
