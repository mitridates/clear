...
class CaveExcludedSerializer extends AbstractSerializer
{

    protected $type = 'caveexcluded';
     ...
     * @return Relationship
     */
    public function cave(Caveexcluded $model): ?Relationship
    {
        return new Relationship(new Resource($model->getCave(), new CaveSerializer($this->router)));
    }
    /**
     * Relationship Fielddefinition
     * @param Caveexcluded $model
     * @return Relationship
     */
    public function excluded(Caveexcluded $model): ?Relationship
    {
        return new Relationship(new Resource($model->getExcluded(), new FieldDefinitionSerializer($this->locale)));
    }
}