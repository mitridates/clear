...
class CaveRocktypeSerializer extends AbstractSerializer
{

    protected $type = 'caverocktype';
    ...
    public function getAttributes($model, array $fields = null): array
    {
        $data= EntityReflectionHelper::serializeClassProperties($model, $fields);
            ...
            $data['rocktype']= $model->getRocktype()->getId();
        return $data;
    }
     ...
     * @return Relationship
     */
    public function cave(Caverocktype $model): ?Relationship
    {
     ...
     * @return Relationship
     */
    public function rocktype(Caverocktype $model): ?Relationship
    {
        return new Relationship(new Resource($model->getRocktype(), new FieldValueCodeSerializer($this->locale)));
    }
}