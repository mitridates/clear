...
class CaveTypeSerializer extends AbstractSerializer
{

    protected $type = 'cavetype';
     ...
     * @return Relationship
     */
    public function cave(Cavetype $model): ?Relationship
    {
     ...
     * @return Relationship
     */
    public function type(Cavetype $model): ?Relationship
    {
