...
class CaveOtherdbidSerializer extends AbstractSerializer
{

    protected $type = 'caveotherdbid';
     ...
     * @return Relationship
     */
    public function cave(Caveotherdbid $model): ?Relationship
    {
     ...
     * @return Relationship
     */
    public function organisation(Caveotherdbid $model): ?Relationship
    {
