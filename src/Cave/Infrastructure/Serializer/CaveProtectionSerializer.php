...
class CaveProtectionSerializer extends AbstractSerializer
{

    protected $type = 'caveprotection';
    ...
    public function getAttributes($model, array $fields = null): array
    {
        ...
        $data['protection']= $model->getProtection()->getId();
        return $data;
    }
     ...
     * @return Relationship
     */
    public function cave(Caveprotection $model): ?Relationship
    {
     ...
     * @return Relationship
     */
    public function protection(Caveprotection $model): ?Relationship
    {
        return new Relationship(new Resource($model->getProtection(), new FieldValueCodeSerializer($this->locale)));
    }
}