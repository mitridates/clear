...
class CaveEntrancelineSerializer extends AbstractSerializer
{

    protected $type = 'caveentranceline';
     ...
     * @return Relationship
     */
    public function cave(Caveentranceline $model): ?Relationship
    {
