...
namespace App\Shared\tobscure\jsonapi;
...
class Document implements JsonSerializable
{
     ...
     * @return Resource[]
     */
    protected function  getIncluded(ElementInterface $element, $includeParent = false): array
    {
        $included = [];
     ...
     * @return $this
     */
    public function setData(ElementInterface $element): self
    {
        $this->data = $element;
