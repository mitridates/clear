...
Trait AdministrativeDivisionSubscriberTrait
{
     ...
     * @return AddCountryFieldSubscriber
     */
    public function getCountry(FormFactoryInterface $factory, string|array $field, ?array $options=[]): AddCountryFieldSubscriber
    {
     ...
     * @param string|array $field
     * @param array|null $options
     * @return AddAdmin1FieldSubscriber
     */
    public function getAdmin1(FormFactoryInterface $factory, array $country, string|array $field, ?array $options=[]): AddAdmin1FieldSubscriber
    {
        if(is_string($field)) $field= $this->getSubscriberData($field);
        $o= array_replace_recursive($field[2]??[], $options);
     ...
     * @param string|array $field
     * @param array|null $options
     * @return AddAdmin2FieldSubscriber
     */
    public function getAdmin2(FormFactoryInterface $factory, array $country, array $admin1, string|array $field, ?array $options=[]): AddAdmin2FieldSubscriber
    {
     ...
     * @param string|array $field
     * @param array|null $options
     * @return AddAdmin3FieldSubscriber
     */
    public function getAdmin3(FormFactoryInterface $factory, array $admin2, string|array $field, ?array $options=[]): AddAdmin3FieldSubscriber
    {
        if(is_string($field)) $field= $this->getSubscriberData($field);
        $o= array_replace_recursive($field[2]??[], $options);
